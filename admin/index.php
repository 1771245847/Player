		...
		<ul class="layui-tab-title">
 		...
 		<div class="layui-tab-content">
				<div class="layui-tab-item layui-show" name="基本设置">
						...
						<div class="layui-input-inline">
							<input type="text" name="yzm[yjbt]" value="<?php echo $yzm['yjbt']?>" size="30" class="layui-input upload-input"placeholder="右键标题 例如：残月解析-弹幕播放器">
						</div>
						<div class="layui-input-inline">
							<input type="text" name="yzm[yjurl]" value="<?php echo $yzm['yjurl']?>" size="30" class="layui-input upload-input"placeholder="标题url">
						</div>
                        ...
                        <div class="layui-form-mid layui-word-aux">B站弹幕ID</div>
                    </div>
						...
						<div class="layui-form-mid layui-word-aux">播放器域名路径</div>
						</div>
                        ...
                        <div class="layui-form-mid layui-word-aux">播放器弹幕接口地址</div>
                    </div>
